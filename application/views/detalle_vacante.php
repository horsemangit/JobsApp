        ...
        <!-- Navigation -->
            <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
                <div class="container">    
                    ...
                    <a class="navbar-brand"><i><font color="WHITE">DETALLE DE OFERTA!</font></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="page-scroll">
                                <a href="<?php echo base_url(); ?>index.php/home/vacantes" style="border-radius: 8px;"><span class="glyphicon glyphicon-search"></span> Vacantes</a>
                            </li>
                ...
                <section class="section summary-section">
                    ...
                    <hr>
                        ...
                        <div class="row">
                            ...
                            <hr>
                                <form id="postularse">
                                    <input type="hidden" name="idpublicacion" id="id_publicacion" value="<?= $id_publicacion ?>">
